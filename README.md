...
- [ShardedRingBuf](https://github.com/asder8215/sharded_ringbuf) ~ A highly efficient asynchronous multiqueue data structure suited for batching operations among a hybrid of I/O and CPU bound work (it can perform certain CPU bound operations pretty efficiently as well like XOR, but you might want to consider Disruptor data structure otherwise).  
